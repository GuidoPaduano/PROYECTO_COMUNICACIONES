...
from .api_admin_staff import (
    ...
    admin_school_user_toggle_active,
...
urlpatterns = [
    ...
    path("admin/schools/<int:school_id>/logo/", admin_upload_school_logo, name="admin_upload_school_logo"),
    path("admin/schools/<int:school_id>/logo", admin_upload_school_logo, name="admin_upload_school_logo_noslash"),
    ...
    path("admin/school-courses/", admin_school_courses, name="admin_school_courses"),
    path("admin/school-courses", admin_school_courses, name="admin_school_courses_noslash"),
    path("admin/school-courses/<int:school_id>/", admin_create_school_course, name="admin_create_school_course"),
    ...
    path("admin/school-users/<int:user_id>/toggle-active/", admin_school_user_toggle_active, name="admin_school_user_toggle_active"),
    path("admin/school-users/<int:user_id>/toggle-active", admin_school_user_toggle_active, name="admin_school_user_toggle_active_noslash"),
    ...
    path("calificaciones/notas/historicas/", notas_historicas, name="notas_historicas"),
    path("calificaciones/notas/historicas", notas_historicas, name="notas_historicas_noslash"),
...
path("mensajes/conversacion/<int:mensaje_id>/", mensajes_conversacion_por_mensaje, name="mensajes_conversacion_por_mensaje"),
    ...
    path("preceptor/alertas-academicas/", preceptor_alertas_academicas, name="preceptor_alertas_academicas"),
