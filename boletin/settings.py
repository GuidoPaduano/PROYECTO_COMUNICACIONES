...
STUDENT_IMPORT_MAX_BYTES = int(os.environ.get("STUDENT_IMPORT_MAX_BYTES", str(5 * 1024 * 1024)))

CRON_SECRET = os.environ.get("CRON_SECRET", "")

ALERTAS_INASISTENCIAS_CONSECUTIVAS = int(os.environ.get("ALERTAS_INASISTENCIAS_CONSECUTIVAS", "3"))
...
ALERTAS_INASISTENCIAS_UMBRALES_FALTAS = os.environ.get("ALERTAS_INASISTENCIAS_UMBRALES_FALTAS", "10,20,28")
